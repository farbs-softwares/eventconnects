			...
			<div>
				...
				>
					...
					<div class="flex items-center mt-3 md:mt-0">
						<router-link
							...
							:to="{
								name: 'CourseDetail',
								params: { eventName: eventResource.data.name },
							}"
						>
							<Button>
								<span>
				...
				<div class="mt-5 mb-10">
					<div class="container mb-5">
						...
						/>
						<FormControl
							v-model="event.short_introduction"
					...
					<div class="container border-t">
						...
						<div class="grid grid-cols-2 gap-10 mb-4">
							...
							<div class="flex flex-col space-y-3">
								...
								<FormControl
									type="checkbox"
									v-model="event.disable_self_learning"
					...
					<div class="container border-t">
						...
						<div class="mb-4">
							<FormControl
								type="checkbox"
								v-model="event.paid_event"
								:label="__('Paid Event')"
							/>
						</div>
						<FormControl
							v-model="event.event_price"
							:label="__('Event Price')"
							class="mb-4"
						/>
						<Link
							doctype="Currency"
...
const eventCreationResource = createResource({
	...
	makeParams(values) {
		return {
			doc: {
				doctype: 'EventsConnect Event',
				image: event.event_image?.file_url || '',
...
const eventEditResource = createResource({
...
const validateMandatoryFields = () => {
	...
	if (event.paid_event && (!event.event_price || !event.currency)) {
		return 'Event price and currency are mandatory for paid events'
	}
}
...
const breadcrumbs = computed(() => {
	...
	crumbs.push({
		label: props.eventName == 'new' ? 'New Event' : 'Edit Event',
		route: { name: 'CreateCourse', params: { eventName: props.eventName } },
	})
	return crumbs
})
</script>
