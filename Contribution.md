...
1. Go to the apps/eventsconnect directory of your installation and execute git pull --unshallow to ensure that you have the full git repository. Also fork the frappe/eventsconnect repository on GitHub.
