...
from eventsconnect.eventsconnect.utils import get_average_rating, get_country_code
from frappe.website.utils import cleanup_page_name
from frappe.model.naming import append_number_if_name_exists
from eventsconnect.widgets import Widgets
...
def get_user_details(users):
	...
	for user in users:
		details = frappe.db.get_value(
			"User",
			user,
			["name", "username", "full_name", "user_image", "headline", "looking_for_eventjob"],
			as_dict=True,
		)
